...
import { View, Modal, Image, TouchableOpacity, StatusBar, ScrollView } from 'react-native';
      ...
      <View style={{ flex: 1, backgroundColor: '#000' }}>
        ...
        <GestureHandlerRootView style={{ flex: 1 }}>
          <View
            ...
            {canvasSize.width > 0 && (
              <ResumableZoom maxScale={6} style={{ flex: 1 }}>
                <View
                  style={{
                      ...
                      <View
                        ...
                        <View
                          ...
                          <Text style={{ color: 'rgba(255,255,255,0.8)', fontSize: 13 }}>
                            {tool === 'circle'
                              ? t('routeAnnotator.hintCircle')
                              : tool === 'path'
                                ? t('routeAnnotator.hintPath')
                                : t('routeAnnotator.hintErase')}
                          </Text>
                        </View>
                      </View>
                    )}
        ...
        <View
          ...
          {tool === 'circle' && (
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
              <Text style={{ color: '#666', fontSize: 11, marginRight: 4 }}>
                {t('routeAnnotator.strokeSize')}
              </Text>
